...
struct ModelLoadInfo {
    ...
    ModelLoadInfo(const std::string& name, const std::string& file,
                const std::shared_ptr<BaseBuffer>& buf, HIAI_PerfMode mode);
};
...
public:
    ...
    static HIAI_ModelManager* CreateModelManager(const HIAI_ModelManagerListenerLegacy* listener);
