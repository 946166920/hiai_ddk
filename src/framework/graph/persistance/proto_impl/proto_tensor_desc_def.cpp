...
const static std::map<Format, std::string> formatToStringMap = {
    ...
    {FORMAT_NC1HWC0_COMPACT, "NC1HWC0_COMPACT"},
    {FORMAT_FRACTAL_Z_COMPACT, "FRACTAL_Z_COMPACT"},
    {FORMAT_FRACTAL_Z_COMPACT_IN, "FRACTAL_Z_COMPACT_IN"},
    {FORMAT_FRACTAL_Z_COMPACT_OUT, "FRACTAL_Z_COMPACT_OUT"},
...
const static std::map<std::string, Format> stringToFormatMap = {
    ...
    {"FRACTAL_NZ", FRACTAL_NZ},
    {"NC1HWC0_COMPACT", FORMAT_NC1HWC0_COMPACT},
    {"FRACTAL_Z_COMPACT", FORMAT_FRACTAL_Z_COMPACT},
    {"FRACTAL_Z_COMPACT_IN", FORMAT_FRACTAL_Z_COMPACT_IN},
    {"FRACTAL_Z_COMPACT_OUT", FORMAT_FRACTAL_Z_COMPACT_OUT},
