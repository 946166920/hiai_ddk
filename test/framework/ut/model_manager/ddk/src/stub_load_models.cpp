...
void StubLoadModels::LoadModelsByV1()
{
    ...
    const string modelPath1 = "bin/llt/framework/domi/modelmanager/tf_softmax_infershaped.om";
    ...
    string modelPath2 = "bin/llt/framework/domi/modelmanager/tf_softmax_no_infershaped.om";
    const MemBuffer* buffer2 = builder->InputMemBufferCreate(modelPath2);
    if (buffer2 == nullptr) {
